...
class Sound(tools._State):
    ...
    def make_image(self):
        ...
        title = Label('Quicksand-Regular', 60, 'Volume', pg.Color('black'),
    ...
    def update_image(self):
        ...
        self.image.blit(self.volumebar.image, self.volumebar.rect)
        ...
        if event.type == pg.KEYDOWN:
            if self.play:
                if event.key == pg.K_ESCAPE:
                    ...
                    self.volumebar.change_volume(-0.1)
                    self.update_image()
